...
class BuildBuilderSpec(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def image_pull_secrets(
            self, value_or_callback: list[v1_1.LocalObjectReference] | None, /
        ...
        def image_pull_secrets(
            ...
            value_or_callback: Callable[
                [GenericListBuilder[v1_1.LocalObjectReference, v1_1.LocalObjectReference.Builder]],
                GenericListBuilder[v1_1.LocalObjectReference, v1_1.LocalObjectReference.Builder]
                | list[v1_1.LocalObjectReference],
            ],
            /,
        ) -> "BuildBuilderSpec.Builder": ...
        ...
        ) -> ListBuilderContext[v1_1.LocalObjectReference.Builder]: ...

        def image_pull_secrets(self, value_or_callback=UNSET, /):
            if self._in_context and value_or_callback is UNSET:
                context = ListBuilderContext[v1_1.LocalObjectReference.Builder]()
            ...
            if callable(value_or_callback):
                output = value_or_callback(v1_1.LocalObjectReference.list_builder())
        ...
        @overload
        def ref(
            self, value_or_callback: v1_1.ObjectReference | None, /
        ) -> "BuildBuilderSpec.Builder": ...
        ...
        def ref(
            self,
            value_or_callback: Callable[
                [v1_1.ObjectReference.Builder],
                v1_1.ObjectReference.Builder | v1_1.ObjectReference,
            ],
            /,
        ) -> "BuildBuilderSpec.Builder": ...

        @overload
        def ref(self, value_or_callback: Never = ...) -> "v1_1.ObjectReference.BuilderContext": ...

        def ref(self, value_or_callback=UNSET, /):
            "Ref reference to an existing Builder/ClusterBuilder"
            if self._in_context and value_or_callback is UNSET:
                context = v1_1.ObjectReference.BuilderContext()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(v1_1.ObjectReference.builder())
                if isinstance(output, v1_1.ObjectReference.Builder):
                    value = output.build()
                else:
                    value = output
    ...
    image_pull_secrets: Annotated[
        list[v1_1.LocalObjectReference] | None, Field(alias="imagePullSecrets")
    ] = None
    ref: v1_1.ObjectReference | None = None
    "Ref reference to an existing Builder/ClusterBuilder"
...
class CNBBinding(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def metadata_ref(
            self, value_or_callback: v1_1.LocalObjectReference | None, /
        ) -> "CNBBinding.Builder": ...
        ...
        def metadata_ref(
            self,
            value_or_callback: Callable[
                [v1_1.LocalObjectReference.Builder],
                v1_1.LocalObjectReference.Builder | v1_1.LocalObjectReference,
            ],
            /,
        ) -> "CNBBinding.Builder": ...
        ...
        def metadata_ref(
            self, value_or_callback: Never = ...
        ) -> "v1_1.LocalObjectReference.BuilderContext": ...

        def metadata_ref(self, value_or_callback=UNSET, /):
            if self._in_context and value_or_callback is UNSET:
                context = v1_1.LocalObjectReference.BuilderContext()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(v1_1.LocalObjectReference.builder())
                if isinstance(output, v1_1.LocalObjectReference.Builder):
                    value = output.build()
                else:
                    value = output
    ...
    metadata_ref: Annotated[v1_1.LocalObjectReference | None, Field(alias="metadataRef")] = None
    name: str | None = None
    secret_ref: Annotated[v1_1.LocalObjectReference | None, Field(alias="secretRef")] = None


class CoreCondition(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> type["CoreCondition"]:
            return CoreCondition

        def build(self) -> "CoreCondition":
            return CoreCondition(**self._attrs)
    ...
    class BuilderContext(BuilderContextBase["CoreCondition.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = CoreCondition.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for CoreCondition."""
        return cls.BuilderContext()

    @classmethod
    def list_builder(cls) -> GenericListBuilder["CoreCondition", Builder]:
        return GenericListBuilder[CoreCondition, CoreCondition.Builder]()
...
class ResolvedGitSource(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def tree(self, value: str | None, /) -> Self:
            return self._set("tree", value)
...
class CoreStatus(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> type["CoreStatus"]:
            return CoreStatus

        def build(self) -> "CoreStatus":
            return CoreStatus(**self._attrs)

        @overload
        def conditions(
            self, value_or_callback: list[CoreCondition] | None, /
        ) -> "CoreStatus.Builder": ...
        ...
        def conditions(
            self,
            value_or_callback: Callable[
                [GenericListBuilder[CoreCondition, CoreCondition.Builder]],
                GenericListBuilder[CoreCondition, CoreCondition.Builder] | list[CoreCondition],
            ],
            /,
        ) -> "CoreStatus.Builder": ...
        ...
        def conditions(
            self, value_or_callback: Never = ...
        ) -> ListBuilderContext[CoreCondition.Builder]: ...

        def conditions(self, value_or_callback=UNSET, /):
            "Conditions the latest available observations of a resource\u0027s current state."
            if self._in_context and value_or_callback is UNSET:
                context = ListBuilderContext[CoreCondition.Builder]()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(CoreCondition.list_builder())
                if isinstance(output, GenericListBuilder):
                    value = output.build()
                else:
                    value = output
    ...
    class BuilderContext(BuilderContextBase["CoreStatus.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = CoreStatus.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for CoreStatus."""
        return cls.BuilderContext()

    @classmethod
    def list_builder(cls) -> GenericListBuilder["CoreStatus", Builder]:
        return GenericListBuilder[CoreStatus, CoreStatus.Builder]()

    conditions: list[CoreCondition] | None = None
    "Conditions the latest available observations of a resource\u0027s current state."
